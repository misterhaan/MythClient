...
namespace Microsoft.Samples {
	...
	public class TaskDialog {
		...
		public TaskDialogButton[] Buttons {
			...
			set {
				this.buttons = value ?? throw new ArgumentNullException("value");
			}
		}
		...
		public TaskDialogButton[] RadioButtons {
			...
			set {
				this.radioButtons = value ?? throw new ArgumentNullException("value");
			}
		}
		...
		public int Show() {
			return this.Show(IntPtr.Zero, out bool verificationFlagChecked, out int radioButtonResult);
		}
		...
		public int Show(IWin32Window owner) {
			return this.Show((owner == null ? IntPtr.Zero : owner.Handle), out bool verificationFlagChecked, out int radioButtonResult);
		}
		...
		public int Show(IWin32Window owner, out bool verificationFlagChecked) {
			return Show((owner == null ? IntPtr.Zero : owner.Handle), out verificationFlagChecked, out int radioButtonResult);
		}
